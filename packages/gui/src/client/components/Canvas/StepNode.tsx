...
import { DataPreviewBadge } from './DataPreviewBadge';
      ...
      >
        ...
        <div className="p-3">
          ...
          {data.lastInput !== undefined && (
            <DataPreviewBadge label="In" data={data.lastInput} variant="input" />
          )}
          {data.lastOutput !== undefined && (
            <DataPreviewBadge label="Out" data={data.lastOutput} variant="output" />
          )}
        </div>
